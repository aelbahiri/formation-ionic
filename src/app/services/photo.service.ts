...
export class PhotoService {
  ...
  public async addNewToGallery() {
    ...
    const positionGps = await Geolocation.getCurrentPosition();

    const savedImageFile = await this.savePicture(capturedPhoto);

    this.photos.unshift(savedImageFile);

    savedImageFile.latitude = positionGps.coords.latitude;
    savedImageFile.longitude = positionGps.coords.longitude;
    Storage.set({
